export const GAME_FRAME_GAP_PX = 1;
export const GAME_FRAME_HUD_RAIL_WIDTH_PX = 214;
export const GAME_FRAME_CAMERA_HEIGHT_PX = 186;
export const GAME_FRAME_CANVAS_MIN_HEIGHT_PX = 520;
export const GAME_FRAME_TELEMETRY_HEIGHT_PX = 104;
